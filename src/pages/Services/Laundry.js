    ...
    return (
        <>
            ...
            <div className="w-full p-2 md:p-12 h-5/6" id="about">
                ...
                As your trusted partner for Home Remodelling Services in Atlanta
                ...
                fittings to stunning interiors, we’ve got you covered.
                            ...
                            <p className="my-3 text-xl text-gray-600 font-semibold text-justify">
                                Transform your outdated Laundry Room interiors into a stunning oasis with Swaminarayan Construction! Don’t let your
                                morning routine be ruined by an uninviting and crumbling Laundry Room. As your trusted partner for Home Remodeling
                                Services in Atlanta, Georgia, we specialize in delivering impeccable Laundry Room renovation solutions that are sure to
                                impress. Our experienced team of accredited remodelers has been winning the hearts of countless homeowners in Atlanta,
                                Georgia, for years with their exceptional workmanship, attention to detail, and commitment to completing projects on time
                                and within budget. We understand that every Laundry Room has its unique set of requirements, and we take the time to
                                understand your needs and preferences to deliver a customized and functional space. From high-quality fittings to
                                stunning interiors, we’ve got you covered.
                            </p>
                        </div>
                        <Link
                            to="/contact"
            ...
            <div className="mt-10 mb-16 flex flex-col items-center text-center">
                <h1 className="my-4 text-5xl text-blue-900 uppercase font-bold">
